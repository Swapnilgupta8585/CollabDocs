...
SELECT id, users.created_at, users.updated_at, email, hashed_password, refresh_token, refresh_tokens.created_at, refresh_tokens.updated_at, user_id, expired_at, revoked_at FROM users 
