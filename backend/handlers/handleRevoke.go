...
func (h *Handler) HandleRevoke(w http.ResponseWriter, r *http.Request){
	...
	RefreshTokenFromDB, err := h.Cfg.Db.GetRefreshTokenFromToken(r.Context(), refreshToken)
	if err != nil {
	...
	err = h.Cfg.Db.UpdateRevokedAtAndUpdateAt(r.Context(), RefreshTokenFromDB.RefreshToken)
	if err != nil{
