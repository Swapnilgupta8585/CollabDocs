        ...
        >
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="border shadow-msm w-full py-2 px-3 text-gray-700 appearance-none rounded leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
